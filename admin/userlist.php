<div class="col-lg-12">
	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="userList">
		...
		<?php
			...
			?>
			<tr>
				<td><input type="hidden" id="ename<?php echo $row['userid']; ?>" value="<?php echo decrypt($row['uname'],$secret); ?>"><?php echo decrypt($row['uname'],$secret); ?></td>
				<td><input type="hidden" id="eusername<?php echo $row['userid']; ?>" value="<?php echo decrypt($row['username'] ,$secret); ?>"><?php echo decrypt($row['username'],$secret); ?></td>
