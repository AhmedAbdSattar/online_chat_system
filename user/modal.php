        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<center><strong><span style="font-size: 15px;">Username: <?php echo decrypt($user,$secret); ?></span></strong></center>
                </div> 
				</div>
            ...
            <div class="modal-content">
				...
				<form method="POST" action="update_account.php">
					...
					<div class="form-group input-group">
						...
						<input type="text" style="width:350px;" class="form-control" name="mname" value="<?php echo decrypt($srow['uname'],$secret); ?>">
					</div>
					<div class="form-group input-group">
